...
gesturelist = ['heart','yearh','five','zan']

gt_path = "gt/gt627-1257.txt"
re_path = "ret_wssdk/627_501007.txt"
re_path = "ret/627_mmcv5bns16f53w_neg2w_1vs1_2img_iter_1150000_9.txt"
re_path = "ret/627_iter115_big6_iter_870000_9.txt"
re_path = "ret/627_iter115_big6_iter_1420000_9.txt"
totalGT = 0
totalRE = 0
totalTP = 0
for gname in gesturelist:
    ...
    #########################################
    f = open(gt_path)
    fnotrecalled = open("./gt/"+gname+"_notrecalled627.txt", "w")
    while True:
        line = f.readline()
        if not line:
            break
        if  (' '+gname+' ')  in line:
            ...
            if not tmp[0] in re_list:
                fnotrecalled.write(tmp[0] +'\n')
            gt_dict[tmp[0]] = []
