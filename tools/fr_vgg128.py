...
if __name__ == '__main__':
    ...
    enScale = 1.5
    bbox_reg_net = caffe.Net("/Users/momo/Desktop/gesture/fromAli/reg/vggTraintest.prototxt", "/Users/momo/Desktop/gesture/fromAli/reg/128_gtTrain3w_0815RS08x10_5_iter_80000.caffemodel", caffe.TEST)
...
#            cv2.rectangle(im, (int(showbox[0]), int(showbox[1])),(int(showbox[2]),int(showbox[3])),(0,0,255),1)
            cv2.rectangle(im, (pred_boxes[0], pred_boxes[1]),(pred_boxes[2],pred_boxes[3]),(0,0,255),1)
