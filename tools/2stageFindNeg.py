...
CONF_THRESH = 0.9
NMS_THRESH = 0.01
fromDir = "//Volumes/song/testVideos/test4neg/oriPic/"
toDir = "/Users/momo/wkspace/caffe_space/detection/py-faster-rcnn/output/Neg/pic/"
toTxtDir = "/Users/momo/wkspace/caffe_space/detection/py-faster-rcnn/output/Neg/modelTxts/"
...
if __name__ == '__main__':
    ...
    negSet = np.array([])
    totalResultsFile = open(toTxtDir+"totalResults.txt", "w")
