...
if __name__ == '__main__':
    ...
    for filename in filelists:
        ...
        for i in xrange(nhand_gt):
            handcls_gt = np.append(handcls_gt, filename.split(' ')[i*4 + 2] )
            box_gt = np.append(box_gt, np.array( [int( filename.split(' ')[i*4 + 3] ) , \
                                                  int( filename.split(' ')[i*4 + 4] ), \
                                                  int( filename.split(' ')[i*4 + 5] ), \
                                                  int( filename.split(' ')[i*4 + 6] ) ]  ))
...
print "recall: ", n_pos_tp/n_pos_gt
print "precision:" , n_pos_tp/n_pos_re
