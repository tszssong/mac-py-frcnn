...
def clip_boxes(boxes, im_shape):
    ...
    boxes[1] = max(boxes[1], 0)
    boxes[2] = min(boxes[2], im_shape[1])
    boxes[3] = min(boxes[3], im_shape[2])
    return boxes
...
if __name__ == '__main__':
    ...
    bbox_reg_net = caffe.Net("/Users/momo/Desktop/gesture/fromAli/reg/traintest64_1x1.prototxt", "/Users/momo/Desktop/gesture/fromAli/reg/1_4w128asFrcnn_0717-2300_iter_840000.caffemodel", caffe.TEST)
